...
const COMMANDS: Command[] = [
  { id: "scan-anomalies", label: "Scan for anomalies", description: "Check all visible wells", prompt: "Scan all wells in the current viewport for anomalies. Report any debit decline or sensor faults.", category: "analysis" },
  ...
  { id: "interference-check", label: "Check well interference", description: "Detect mutual influence", prompt: "Check for well interference in the current viewport. Are wells close enough to cause mutual influence between each other?", category: "analysis" },

  { id: "region-overview", label: "Region overview", description: "Summary statistics", prompt: "Give me a complete overview of the region I'm looking at: total wells, active/inactive count, average yield, summary statistics, any concerns.", category: "monitoring" },
  ...
  { id: "compare-clusters", label: "Compare clusters", description: "Cross-cluster comparison", prompt: "Compare clusters visible in the viewport. Which cluster has the highest/lowest yield? Which has best/worst overall metrics?", category: "data" },

  { id: "daily-report", label: "Generate daily report", description: "Summary report", prompt: "Generate a daily monitoring report for all wells in the viewport. Include: operational status, recent issues, and recommendations.", category: "report" },
];
